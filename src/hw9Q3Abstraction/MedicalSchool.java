...
public abstract class MedicalSchool extends NursingSchool {
	 ...
	 * Abstract class can be inherit interface by implement and regular class as well.
	 *  How many inheritances is possible by an Abstract Class? more than one by using exteds and     
	 *  implements keywords
	 */
